...
### Configuration Guide (in `.cursor/motia/rules`)
...
### Step Type Guides (in `.cursor/motia/rules`)
...
### Architecture Guides (in `.cursor/motia/architecture/`)
...
Remember: The 11 cursor rules in `.cursor/motia/rules/` are your source of truth. Always read them first.

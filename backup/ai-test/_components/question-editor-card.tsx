...
import type { CompanyStage } from '../_types/generation-types';
...
export interface GeneratedQuestion {
  ...
  expectations: {
    scoringAnchors: import('../_types').ScoringAnchors; // 5x2 bucket scoring system
    followUpQuestions: import('../_types').FollowUpQuestion[];
  };

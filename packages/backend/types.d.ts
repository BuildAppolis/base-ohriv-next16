...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'MLPredict': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { success: boolean; result?: unknown; error?: string; error_type?: string; traceback?: string; stdout?: string; stderr?: string }> | ApiResponse<400, { error: string }> | ApiResponse<500, { error: string; config: unknown }>, never>

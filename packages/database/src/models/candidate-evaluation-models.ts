// RavenDB Document Models for Candidate Evaluation Tracking
// These models track candidate evaluations based on KSA guidelines
 ...
 */
export interface CandidateKSADocument extends RavenDocument {
 ...
 */
export interface KSAResponseTemplateDocument extends RavenDocument {
 ...
 */
export interface KSABenchmarkDocument extends RavenDocument {

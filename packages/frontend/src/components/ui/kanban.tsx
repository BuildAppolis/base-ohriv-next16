...
// Note: Using 'any' here is acceptable because:
// 1. This context is generic and can work with any item type T
// 2. The actual typing is enforced at runtime by the provider and consumers
// 3. TypeScript struggles with generic contexts that need to be compatible with any T
// 4. All components using this context should properly type their usage
const KanbanContext = React.createContext<KanbanContextProps<any> | null>(null);

// Helper hook to use the kanban context with proper error handling
function useKanbanContext(): KanbanContextProps<any> {

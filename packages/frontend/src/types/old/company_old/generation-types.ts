...
export interface GeneratedJobTemplate {
  ...
  positionCulture: {
    workEnvironment: WorkEnvironmentId; // How this role works (remote/hybrid/office)
    workPace: WorkPaceId; // Pace of this specific role
    collaborationStyle: CollaborationStyleId; // How this role collaborates
  };
